...
\title{File Management System Project}
\author{Lizbeth Ochoa}
\date{CS 3502 Section W03}
...
I chose Python in this project because of my familiarity with the language and how simple it is. As well as how it supports file operations through the os module. Paired with Tkinter as recommened for GUI development because of how well it integrates with Python.
...
Metadata is retrieved and stored by Inodes. Such as permissions and file size, and directory entries map filenames to inode numnbers.

\section{Design and Architechture}
